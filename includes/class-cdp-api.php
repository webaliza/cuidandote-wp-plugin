...
class CDP_API {
	 ...
	 *
	 * NOTA: No incluimos 'args' con 'required' porque el payload viene
	 * envuelto en {"data": {...}} y WordPress valida args antes del callback.
	 * La validación se hace dentro de crear_presupuesto() después de extraer 'data'.
	 */
	public static function register_routes() {
		register_rest_route('cuidandote/v1', '/presupuesto', array(
			array(
				...
				// Sin 'args' - validación manual en el callback
			),
			array(
				'methods'             => 'OPTIONS',
